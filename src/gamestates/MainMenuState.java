...
public class MainMenuState extends State {
    ...
    private final int buttonWidth = (int) (200 * BasicGUIConstants.rsf);
    ...
    public MainMenuState() {
        buttons.put("playButton", new ButtonTriangularRectangle(DisplayManager.getWIDTH() / 2 - buttonWidth / 2, DisplayManager.getHEIGHT() / 2 - buttonHeight * 2, buttonWidth, buttonHeight, buttonCutoffSize, "Play"));
        buttons.put("howToPlayButton", new ButtonTriangularRectangle(DisplayManager.getWIDTH() / 2 - buttonWidth / 2, DisplayManager.getHEIGHT() / 2 - buttonHeight / 2, buttonWidth, buttonHeight, buttonCutoffSize, "How To Play"));
        buttons.put("quitButton", new ButtonTriangularRectangle(DisplayManager.getWIDTH() / 2 - buttonWidth / 2, DisplayManager.getHEIGHT() / 2 + buttonHeight, buttonWidth, buttonHeight, buttonCutoffSize, "Quit"));
