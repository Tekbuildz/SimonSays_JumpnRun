...
public class StatisticsMenuState extends State{
    ...
    private final TextBox title = new TextBox(0, DisplayManager.getHEIGHT() / 8, DisplayManager.getWIDTH(), BasicGUIConstants.BUTTON_TEXT_COLOR, new Font("Calibri", Font.PLAIN, 80), "Statistics", 0, UIConstraints.UI_CENTER_BOUND_CONSTRAINT);
    ...
    public StatisticsMenuState() {
        ...
        int textHeightDifference = (int) (80 * BasicGUIConstants.rsf);
        int textWidth = DisplayManager.getWIDTH() / 2;
        Font font = new Font("Calibri", Font.PLAIN, 40);

        descriptions[0] = new TextBox(textX, textYBase, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, "Total money in bank: ", 0, UIConstraints.UI_LEFT_BOUND_CONSTRAINT);
        descriptions[1] = new TextBox(textX, textYBase + textHeightDifference, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, "Total items collected: ", 0, UIConstraints.UI_LEFT_BOUND_CONSTRAINT);
        descriptions[2] = new TextBox(textX, textYBase + textHeightDifference * 2, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, "Number of snails killed: ", 0, UIConstraints.UI_LEFT_BOUND_CONSTRAINT);
        descriptions[3] = new TextBox(textX, textYBase + textHeightDifference * 3, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, "Number of wolfs killed: ", 0, UIConstraints.UI_LEFT_BOUND_CONSTRAINT);

        values[0] = new TextBox(textX, textYBase, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, String.valueOf(DataLoader.getCoins()), 0, UIConstraints.UI_RIGHT_BOUND_CONSTRAINT);
        values[1] = new TextBox(textX, textYBase + textHeightDifference, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, String.valueOf(DataLoader.getItems()), 0, UIConstraints.UI_RIGHT_BOUND_CONSTRAINT);
        values[2] = new TextBox(textX, textYBase + textHeightDifference * 2, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, String.valueOf(DataLoader.getEntityKills().get("snail")), 0, UIConstraints.UI_RIGHT_BOUND_CONSTRAINT);
        values[3] = new TextBox(textX, textYBase + textHeightDifference * 3, textWidth, BasicGUIConstants.BUTTON_TEXT_COLOR, font, String.valueOf(DataLoader.getEntityKills().get("wolf")), 0, UIConstraints.UI_RIGHT_BOUND_CONSTRAINT);
